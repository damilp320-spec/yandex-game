...
export const INCOME = {
  ...
  offlineCapHours: 8,
  /**
   * Офлайн платит долю от активной ставки. При полной ставке 8 часов сна давали
   * больше монет, чем весь остальной день игры (при доходе 3.1k за тик — 17.9M за
   * ночь), и офлайн становился главным источником вместо игры — измерено в sim.
   */
  offlineRate: 0.4,
