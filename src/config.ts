...
// Клетки выросли с 126 до 136: место освободилось после переноса генераторов вниз и
// сжатия заказов в одну полосу — оно ушло в размер существ, их проще тащить пальцем.
export const GRID = { cols: 5, rows: 6, cell: 136, x: 20, y: 240 };
